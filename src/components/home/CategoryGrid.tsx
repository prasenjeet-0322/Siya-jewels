    ...
    <section className="py-16 sm:py-24 bg-[#FFFFFF]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-50 border border-amber-200 text-amber-800 text-xs font-semibold uppercase tracking-widest mb-3">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
          {CATEGORIES_DATA.map((cat) => (
            <Link
              ...
              className="group relative rounded-2xl overflow-hidden bg-[#FAF7F2] border border-amber-100 hover:border-[#D4AF37] shadow-sm hover:shadow-xl transition-all duration-500 flex flex-col aspect-[4/5]"
            >
              {/* Image */}
              ...
              {/* Bottom Card Info */}
              <div className="absolute inset-x-0 bottom-0 p-4 sm:p-5 flex items-end justify-between text-white z-10">
                <div>
                  <span className="text-[10px] text-amber-300 uppercase tracking-wider font-semibold block">
                    {cat.itemCount}+ Designs
                  </span>
                  <h3 className="font-serif text-lg sm:text-xl font-bold text-white group-hover:text-amber-200 transition">
                    {cat.name}
                  </h3>
                ...
                <div className="w-8 h-8 rounded-full bg-white/20 backdrop-blur-md group-hover:bg-[#D4AF37] group-hover:text-black flex items-center justify-center transition-colors shrink-0">
